...
def test_should_not_allow_create_password_with_7_small_letters():
    ...
    registration_password_field.send_keys(password.PASSWORD_7_SMALL_LETTERS.password)

    registration_repassword_field = password_page.find_email_repassword_field()
    registration_repassword_field.send_keys(password.PASSWORD_7_SMALL_LETTERS.password)
    time.sleep(1)

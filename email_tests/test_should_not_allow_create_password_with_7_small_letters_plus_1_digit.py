...
def test_should_not_allow_create_password_with_7_small_letters_plus_1_digit():
    ...
    registration_password_field.send_keys(password.PASSWORD_7_SMALL_LETTERS_PLUS_1_DIGIT.password)

    registration_repassword_field = password_page.find_email_repassword_field()
    registration_repassword_field.send_keys(password.PASSWORD_7_SMALL_LETTERS_PLUS_1_DIGIT.password)
    time.sleep(1)

    password_page.make_screenshot('password_7_letters_plus_1_digit.png')
